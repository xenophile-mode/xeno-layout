...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_P,         KC_A,        KC_S,          KC_D,    KC_F,    KC_G,                                        KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, GUI_T(KC_QUOT),
  KC_LSFT,         CTL_T(KC_Z), KC_X,          KC_C,    KC_V,    KC_B,    KC_NO,                      KC_ESC, KC_N,    KC_M,    KC_COMM, KC_DOT,           KC_SLSH, KC_RSFT,
  KC_GRV, KC_QUOT,     LALT(KC_LSFT), KC_LEFT, KC_RGHT,                                              KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, MEH_T(KC_NO),
                                                           KC_DEL, KC_COPY,                KC_PSTE, CTL_T(KC_ESC),
                                                                          KC_HOME,                 KC_PGUP,
                                                         KC_LALT, KC_BSPC, KC_END,                  KC_PGDN, KC_ENT, KC_SPC
),
